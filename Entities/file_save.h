...
/**
Writes Entity data to a binary save file.
Format:
...
/**
Reads binary files generated by SaveFileWriter. For file format details, see the class definition of SaveFileWriter.
*/
